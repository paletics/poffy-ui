...
const InputEndElementImpl = forwardRef<Element, InputElementProps>(
...
InputEndElementImpl.displayName = 'InputEndElement';

/**
 * Inline-end element positioned inside the field.
 *
 ...
 * non-void child host.
 */
export const InputEndElement = Object.assign(InputEndElementImpl as InputElementComponent, {
  [INPUT_GROUP_SLOT]: 'endElement' as const,
});
