...
export const diffViewerRecipe = defineSlotRecipe({
  ...
  slots: [
    ...
    'caption',
    'captionDisclosure',
    'captionDisclosureSummary',
    'captionDisclosureContent',
    'body',
    'hunk',
    'hunkHeader',
    'row',
  ...
  base: {
    ...
    row: {
      ...
      alignItems: 'stretch',
      minW: 'max-content',
      borderInlineStart: '{borderWidths.strong} solid var(--diff-accent)',
      borderBlockStart: '1px solid',
      borderBlockStartColor: 'color-mix(in srgb, {colors.layout.divider} 58%, transparent)',
      bg: 'var(--diff-row-bg)',
      '&[data-change=added]': {
  ...
  variants: {
    ...
    size: {
      sm: {
        ...
        captionDisclosureSummary: { px: '{spacing.sm}', py: '{spacing.xs}' },
        captionDisclosureContent: { px: '{spacing.sm}', pb: '{spacing.sm}' },
