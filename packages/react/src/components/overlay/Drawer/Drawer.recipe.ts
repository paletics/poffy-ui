 ...
 * `compoundVariants` override to restore `width: 100vw` and apply `height` instead
...
export const drawerRecipe = defineSlotRecipe({
  ...
  compoundVariants: [
    // top/bottom: size controls height, not width (restore width: 100vw)
    { placement: 'top', size: 'sm', css: { content: { width: '100vw', height: '{sizes.sm}' } } },
    { placement: 'top', size: 'md', css: { content: { width: '100vw', height: '{sizes.md}' } } },
    { placement: 'top', size: 'lg', css: { content: { width: '100vw', height: '{sizes.lg}' } } },
    { placement: 'top', size: 'xl', css: { content: { width: '100vw', height: '{sizes.xl}' } } },
    { placement: 'top', size: 'full', css: { content: { width: '100vw', height: '100vh' } } },
    { placement: 'bottom', size: 'sm', css: { content: { width: '100vw', height: '{sizes.sm}' } } },
    { placement: 'bottom', size: 'md', css: { content: { width: '100vw', height: '{sizes.md}' } } },
    { placement: 'bottom', size: 'lg', css: { content: { width: '100vw', height: '{sizes.lg}' } } },
    { placement: 'bottom', size: 'xl', css: { content: { width: '100vw', height: '{sizes.xl}' } } },
    { placement: 'bottom', size: 'full', css: { content: { width: '100vw', height: '100vh' } } },
  ],
  defaultVariants: {
    appearance: 'soft',
    placement: 'right',
